...
public extension GrapeVarietyRepository {
    var fetchAll: @MainActor @Sendable () async throws -> [GrapeVarietyEntity] {
        base.fetchAll
    }

    var fetch: @MainActor @Sendable (UUID) async throws -> GrapeVarietyEntity? {
        base.fetch
    }

    var upsert: @MainActor @Sendable (GrapeVarietyEntity) async throws -> GrapeVarietyEntity {
        base.upsert
    }
